...
function soundex(name) {
    ...
    // Pad with zeros if necessary to ensure length is 3
    if (si <= 3) {
        while (si <= 3) {
            s[si] = '0';
            si++;
...
// Prototype method to calculate hash code for strings
...
// Function to encode string in UTF-8 format
